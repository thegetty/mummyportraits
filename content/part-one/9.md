...
{{< q-figure-group grid="2" id="fig_9_1, fig_9_2" >}}
...
The eight-point frame is constructed of four overlapping individual members that are joined by mortise and tenon with square shoulders, reinforced by wooden pegs that are raised at each corner ([fig. 9.2](#fig_9_2)). Great care was taken in the arrangement of these wooden frame members; the wane edges, meaning those that would have originally possessed protective bark, were placed with the smooth side facing toward the inside of the frame---seen here on the panel reverse. Thus, it would appear that the maker intended to conceal the imperfections in this scarce wooden resource from being visible along the edge of the outer frame ([fig. 9.4](#fig_9_4)).[^44]
