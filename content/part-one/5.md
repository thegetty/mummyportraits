...
In terms of provenance, of the forty-seven portraits with Egyptian blue, fifteen are from {{< q-def "Hawara" >}}, eleven from er-Rubayat, seven from Tebtunis, one from {{< q-def "Antinoöpolis">}}, one possibly from Saqqara, and one possibly from El-Hibeh; eleven have no known {{< q-def "provenience" >}}. This distribution indicates that Egyptian blue was used on portraits found at all the major find sites and suggests that the pigment was used in all of the known production centers of funerary panel paintings.
