...
The forty-seven portraits with Egyptian blue vary in date, {{< q-def "provenance" >}}, and style. In terms of date range, it is now clear that the pigment was used throughout the whole period of production of painted mummy portraits, from the mid-first century AD, as in the Menil Collection's late {{< q-def "Julio-Claudian period" "Julio-Claudian" >}} portrait (MFAH 2009.16) on which the pearl earrings are highlighted with Egyptian blue, to at least the mid-third century AD, as in the Cantor portrait ([figs. 5.1](#fig_5_1) and [5.2](#fig_5_2)).
