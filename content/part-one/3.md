...
Identification of specific HAs has been carried out by several techniques. Of them, the one that in principal requires the smallest sample is {{< q-def "Raman spectroscopy" "surface-enhanced Raman spectroscopy (SERS) ">}}. It has been shown that three of the major HAs found in many Rubiaceae (alizarin, purpurin, and pseudopurpurin) can be identified by SERS; however, if more than one HA is present in a given sample, SERS may detect only one of them.[^9]
...
[^13]: {{< q-cite "Mouri and Laursen 2012" >}}. Certain varieties of Asian *R. cordifolia* contain some unusual HAs that permit their specific characterization ({{< q-cite "Han et al. 2016" >}}), but this does not seem to the case with the variety of *R. cordifolia* available in the Mediterranean region.
