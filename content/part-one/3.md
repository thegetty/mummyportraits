...
Madder, a {{< q-def "lake" >}} {{< q-def "pigment" >}}, may be one of the more common colorants used in Egyptian mummy portraits. As a pure pigment, it is pink or red, sometimes slightly purplish, and is most often noted as the major coloring in red and purple drapery and *clavi* ([figs. 3.1](#fig_3_1) and [3.2](#fig_3_2)). Madder has been found mixed with a blue pigment in purple drapery, and it is commonly noted on lips and highlights on faces.
...
{{< q-figure-group grid="2" id="fig_3_3, fig_3_4" >}}
