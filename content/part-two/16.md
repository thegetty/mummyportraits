...
Based on analysis with ultraviolet-induced visible fluorescence (UVF), X-ray fluorescence (XRF), scanning electron microscopy and energy dispersive X-ray spectroscopy (SEM-EDS), {{< q-def "FTIR" "Fourier transform infrared spectroscopy (FTIR)" >}}, and Raman spectroscopy, the painted surface appears to include {{< q-def "carbon black">}}; calcium-based whites including {{< q-def "gypsum" >}} and chalk; lead white; orpiment; organic red (likely rose madder); vermilion; indigo; and red and yellow iron oxide pigments.
