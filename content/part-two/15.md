...
For all fifteen investigated portraits the common use of {{< q-def "earth pigments" >}} was confirmed. Additionally, lead white, orpiment or realgar, copper green, {{< q-def "Egyptian blue" >}}, madder, and gold were detected. Also identified were three different types of {{< q-def "ground" >}} layers: calcite, {{< q-def "gypsum" >}}, and lead white.
